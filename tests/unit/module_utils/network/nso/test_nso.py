...
from ansible_collections.ansible.nso.tests.unit.compat import unittest
from ansible_collections.ansible.nso.plugins.module_utils.network.nso import nso
